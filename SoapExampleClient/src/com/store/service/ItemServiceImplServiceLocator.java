...
public class ItemServiceImplServiceLocator extends org.apache.axis.client.Service implements com.store.service.ItemServiceImplService {
    ...
    private java.lang.String ItemServiceImpl_address = "http://localhost:8085/SoapExample/services/ItemServiceImpl";
    ...
    public com.store.service.ItemServiceImpl getItemServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.store.service.ItemServiceImpl getItemServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.store.service.ItemServiceImplSoapBindingStub _stub = new com.store.service.ItemServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.store.service.ItemServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.store.service.ItemServiceImplSoapBindingStub _stub = new com.store.service.ItemServiceImplSoapBindingStub(new java.net.URL(ItemServiceImpl_address), this);
                _stub.setPortName(getItemServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.store.com", "ItemServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.store.com", "ItemServiceImpl"));
        }
